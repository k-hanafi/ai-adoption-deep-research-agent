...
STAGE2_TEST_RUNS_DIR = OUTPUT_DIR / "test_runs"
STAGE2_RUNS_DIR = OUTPUT_DIR / "runs"
STAGE2_MASTER_JSONL = OUTPUT_DIR / "production_results.jsonl"
STAGE2_MASTER_CSV = OUTPUT_DIR / "production_results.csv"
