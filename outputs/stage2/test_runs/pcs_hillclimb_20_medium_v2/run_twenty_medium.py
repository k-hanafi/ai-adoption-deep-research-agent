"""Paid PCS hill-climb: same 20 companies, 3× medium, current prompts, concurrent.

Paired with pcs_hillclimb_20_high/ (same prompts, high effort).
Does not overwrite the pre-prompt-lock medium run in pcs_hillclimb_20/.

Usage:
  PYTHONPATH=. python3 outputs/stage2/test_runs/pcs_hillclimb_20_medium_v2/run_twenty_medium.py
"""
