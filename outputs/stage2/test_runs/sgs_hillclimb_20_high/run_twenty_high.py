"""Paid SGS hill-climb: same 20 companies, digs at package-default high.

Measurement only. Does not change SGS package defaults.
...
Usage:
  PYTHONPATH=. python3 outputs/stage2/test_runs/sgs_hillclimb_20_high/run_twenty_high.py
"""
...
DIG_EFFORT = "high"  # package default; recorded for traces only
TIMEOUT_S = 600.0
WORKERS = 4
